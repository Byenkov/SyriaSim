...
public class Country {
	...
	public Country(double pX, double pY){
		provinces.put("Hama", new Province("Hama" , "Maps/Hama.png", pX + 0.0, pY + 0.0));
		provinces.put("Homs", new Province("Homs", "Maps/Homs.png", pX - 11.0, pY + 25.0));
		provinces.put("Rif Dimashq", new Province("Rif_Dimashq", "Maps/Rif Dimashq.png", pX - 25.0, pY + 133.0));
		provinces.put("As-Suwayda", new Province("As_Suwayda", "Maps/As-Suwayda.png", pX + 8.0, pY + 217.0));
		provinces.put("Deir ez-Zor", new Province("Deir_ez_Zor", "Maps/Deir ez-Zor.png", pX + 225.5, pY - 60.5));
		provinces.put("Al-Hasakah", new Province("Al_Hasakah", "Maps/Al-Hasakah.png",  pX + 243.0, pY - 133.0));
		provinces.put("Ar-Raqqah", new Province("Ar_Raqqah", "Maps/Ar-Raqqah.png",  pX + 137.2, pY - 86.9));
		provinces.put("Aleppo", new Province("Aleppo", "Maps/Aleppo.png", pX + 27.0, pY - 100.0));
		provinces.put("Idlib", new Province("Idlib", "Maps/Idlib.png",  pX - 3.0, pY - 50.0));
		provinces.put("Latakia", new Province("Latakia", "Maps/Latakia.png",  pX - 31.0, pY - 13.0));
		provinces.put("Tartus", new Province("Tartus", "Maps/Tartus.png", pX - 23.0, pY + 44.0));
		provinces.put("Dimashq", new Province("Dimashq", "Maps/Dimashq.png", pX + 2.0, pY + 188.5));
		provinces.put("Daraa", new Province("Daraa", "Maps/Daraa.png", pX - 27.5, pY + 212.0));
		provinces.put("Quneitra", new Province("Quneitra", "Maps/Quneitra.png", pX - 47.0, pY + 206.0));
	}
